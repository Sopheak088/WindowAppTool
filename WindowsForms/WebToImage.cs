...
using System.IO;
using static WindowsForms.File2;

namespace WindowsForms
{
    public class WebToImage
    {
        public class HtmlCapture
        {
            ...
            void tready_Tick(object sender, EventArgs e)
            {
                try
                {
                    ...
                    int width = 1200;// Math.Max(body2.scrollWidth, root2.scrollWidth);
                    int height = 600;// Math.Max(root2.scrollHeight, body2.scrollHeight);
